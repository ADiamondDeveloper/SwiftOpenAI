...
struct AIProxyService: OpenAIService {
    ...
    debugEnabled: Bool)
  {
    ...
    openAIEnvironment = .init(baseURL: serviceURL ?? "https://api.aiproxy.pro", proxyPath: proxyPath, version: apiVersion ?? "v1", extraHeaders: extraHeaders, includeUsage: includeUsage)
